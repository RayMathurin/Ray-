...
public class StrawPoll {
    ...
    private transient String pollURL = "";
     ...
     /**
     * Default constructor, sets the title of the poll to "Default Example Title"
 NOTE: You will have to call create() to send a POST request to create a Example on the website.
     */
    public StrawPoll() {
  ...
  NOTE: You will have to call create() to send a POST request to create a Example on the website.
     ...
     */
    public StrawPoll(Example poll){ //Copy Constructor
        updatePoll(poll);
    }

    /**
     * This creates a Example object by retrieving the data from the poll url provided
     ...
     * @param options - The options of the Example
     */
    ...
    /**
     * This creates a Example object with the title and the options in the List<String> passed.
     * NOTE: You will have to call create() to send a POST request to create a StrawPoll on the website.
     * @param title - The title of the Example
     * @param options - The options of the Example
     */
    ...
    public void create() {
        ...
        try{
            ...
            Example returnedPoll = gson.fromJson(returnedJSON, Example.class);
    ...
    public void update() {
        ...
        try{
            ...
            br.close();
            Gson gson = new Gson();
            Example returnedPoll = gson.fromJson(jsonMessage, Example.class);
            updatePoll(returnedPoll);
        } catch(IOException e){
            e.printStackTrace();
        }
    ...
    private void updatePoll(Example poll){
        this.id = poll.getId();
     ...
     */
    public Example retrieve(String url){
     ...
     * It then returns a StrawPoll object with the data retrieved.
     * @param id - The integer id of the Example
     * @return - The strawpoll object, null if the link is invalid.
     */
    public Example retrieve(int id){
     ...
     */
    public Example setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     */
    public Example setOptions(List<String> options){
        this.options = options;
        return this;
    }
     ...
     * @return - The updated strawpoll object for method chaining
     */
    public Example addOptions(String... options){
     ...
     * @return - The instance of this class (for method-chaining)
     */
    public Example setIsMulti(boolean multi) {
        isMulti = multi;
        return this;
    }
     ...
     * @return - The instance of this class (for method-chaining)
     */
    public Example setHasCaptcha(boolean hasCaptcha) {
        this.hasCaptcha = hasCaptcha;
        return this;
    }
     ...
     * @return - The instance of this class (for method-chaining)
     */
    public Example setDupCheck(DupCheckType dupCheck) {
        this.dupCheck = dupCheck.toString();
        return this;
    }
